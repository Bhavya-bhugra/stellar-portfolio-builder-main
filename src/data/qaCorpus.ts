...
/**
 * Curated question/answer corpus powering the Samvaad section.
 * Structured so it can grow to 500+ pairs without changing the engine:
 * each entry is one intent with several phrasings.
 */
